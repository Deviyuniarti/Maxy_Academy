...
function plantall(){
    ...
    $html = _retriever('https://farmrpg.com/worker.php?go=plantall&id=707890', NULL, $header, 'POST' );
    return $html;
}
...
function harvestall(){
    ...
    $html = _retriever('https://farmrpg.com/worker.php?id=707890&go=harvestall', NULL, $header, 'POST' );
    return $html;
}
