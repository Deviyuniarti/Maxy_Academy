            ...
            <div class="card-body">
                <form action="/sales_order/simpan-data" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="name" name="supplier_name" id="supplier_name" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="received_status" id="received_status" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
